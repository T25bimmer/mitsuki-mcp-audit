...
export type NormalizeJson = { [key in Exclude<Severity, "info">]:NormalizeInfo[] }
export interface AuditResult {
  auditReportVersion:number
  vulnerabilities:{ [key:string]:AuditVulnerabilitie }
  metadata:{
      vulnerabilities:{
...
export interface DataDesc {
    ...
    desc:{
        severityLevels: { [key in Exclude<Severity,'info'>]:string }
    }
}
interface Action {
    isMajor:boolean
